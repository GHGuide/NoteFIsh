...
test('a call is recognised from the apps that are running or the tabs that are open', () => {
  assert.deepEqual(detectCall({ processes: ['Finder', 'zoom.us', 'Google Chrome'] }), { app: 'Zoom', kind: 'app', via: 'zoom.us', live: true, bundle: '' });
  ...
  assert.deepEqual(meet, { app: 'Google Meet', kind: 'web', via: 'Google Chrome', live: true, bundle: '' });
