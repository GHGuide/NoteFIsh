...
node driver/probe.mjs     # proves it: sends a tone in over UDP, records it back from the mic, expects ~440 Hz
```
...
Uninstall: `sudo rm -rf /Library/Audio/Plug-Ins/HAL/NoteFishVoice.driver && sudo killall coreaudiod`.
